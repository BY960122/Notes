...
## 执行sql并返回结果
```sh
sqoop eval --connect jdbc:mysql://192.168.1.6:3306/ecif_etl_test --driver com.mysql.cj.jdbc.Driver --username root --password By96o122 -e "SELECT client_id,client_majorcate FROM t_ods_bib_t_cm_clientinfo_hv" 
```

## MySQL中的表复制到hive
```sh
sqoop import --connect jdbc:mysql://192.168.1.6:3306/ecif_etl_test \
--driver com.mysql.cj.jdbc.Driver --username root --password By96o122 \
